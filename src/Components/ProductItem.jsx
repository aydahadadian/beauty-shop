import { FavoriteBorderOutlined , StarOutlined, SearchOutlined} from '@material-ui/icons'
...
width: 100%;
height:260px;
background: ${(props) => props.theme.bc.secondary};
display: flex;
justify-content: center;
align-items: center;
    ...
    return (
        <Container width={width} margin={margin}>
            ...
            <Bottom>
                ...
                <Row>
                <button onClick={()=>handleClick(item)} style={{width:"80%"}}> ADD TO CART</button>
